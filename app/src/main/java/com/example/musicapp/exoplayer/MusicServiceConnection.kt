...
class MusicServiceConnection(context: Context) {
    ...
    private val _currentingPlayingSong = MutableLiveData<MediaMetadataCompat?>()
    val currentingPlayingSong: LiveData<MediaMetadataCompat?> = _currentingPlayingSong
   ...
   private val mediaBrowser = MediaBrowserCompat(context, ComponentName(
       context, MusicServices::class.java
    ...
    private inner class MediaBrowserConnectionCallback(private val context: Context): MediaBrowserCompat.ConnectionCallback(){
        ...
        override fun onConnectionFailed() {
            _isConnected.postValue(Event(Resource.error("Media browser problem", false)))
        }
    }
    ...
    private inner class MediaControllerCallback: MediaControllerCompat.Callback(){
        ...
        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            _currentingPlayingSong.postValue(metadata)
        }
